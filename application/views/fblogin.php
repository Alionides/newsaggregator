<html>
<head>
    <title>Surf.az | Facebook Giriş</title>
...
<body>
    ...
    <div class="container">
        ...
        <form class="form-signin" role="form">
            ...
            <?php else: ?>
                <h2 class="form-signin-heading">Facebook Giriş</h2>
                <a href="<?= $login_url ?>" class="btn btn-lg btn-primary btn-block" role="button">Daxil Ol</a>
            <?php endif; ?>
