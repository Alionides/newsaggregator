	...
	<script type="text/javascript">
		...
		var loaded_messages = 0;
			$("#more_button").click(function(){
				loaded_messages += 16;
				$.get("http://surf.az/site/getusernews/" + loaded_messages, function(data){
  ...
  <div class="container-fluid">
      <h2 class="text-center">
        ...
        <?php
            ...
            ?> 
<?php
       //   echo "<img class='img-thumbnail' data-src='holder.js/140x140' alt='140x140' src='https://graph.facebook.com/$fbid/picture?type=large' style='width: 40px; height: 40px;'>";
...
?>
      ...
      <!-- <form class="form-vertical" role="form" action='<?php echo base_url(); ?>site/insertusernews' method="post">-->

        <?php echo form_open_multipart('site/insertusernews'); ?>
        <div class="form-group">
         ...
         <!-- <label for="email">Img Url:</label>
          ...
          <label for="sel1">Kateqoriya Seçin</label>
