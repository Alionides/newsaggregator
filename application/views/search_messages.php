...
<a itemprop="url" data-position="1" data-content-id="1wnAqWO" class="story-link" href="<?php echo base_url();?>site/tapdim/<?php echo $totalsiteid.'/'.$new->slug; ?>" target="_self">
    <img class="story-image-img" src="<?php echo $new->site_img_url;?>" width="312" height="170" alt="<?php echo $new->site_title;?>">
</a>
</div>
...
<a itemprop="url" class="story-title-link story-link" rel="bookmark" itemprop="url" href="<?php echo base_url();?>site/tapdim/<?php echo $totalsiteid.'/'.$new->slug; ?>" target="_self">
