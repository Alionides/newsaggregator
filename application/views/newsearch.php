...
<div class="container-fluid" style="height: 100%; min-height: 20em;">
  ...
  <div id="columsofsurf" class="row">
    	...
    	<?php
        if(!$results2){
         		echo "<p style='color:#0288d1; font-size:72px;text-align:center;'>Axtarışa uyğun nəticə tapılmadı</p>";
		}else{
