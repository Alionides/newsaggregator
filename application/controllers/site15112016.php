...
public function tapdim($last_id = FALSE)
       {
        ...
        public function fbinsert(){
          ...
          $page_access_token = 'EAAFedWpXIV0BAGwaEUZBMSfJCdoulu53Lj6zaqODEPVSkZA2Cqo3BEGVsckJyoGYRP8K4Ll0QokGtNQ7ZCfSZAavr5VAMmLHTifZCwoin1sIpPZARE1p2z832tubVkuEqPzC6osRFKwI8tVRROrRSUA7xMxBohqZBqSPkEkxELusAZDZD';
...
$maintext = strstr($innertext, '$(' , true).'<br><br>';


foreach($html->find('.article-content img') as $e) { 
...
$html = file_get_html('http://haqqin.az/news'); 
foreach($html->find('.news-list img') as $e) { 
   $imgarray[] = $e->src;
}
   $mainimage = $imgarray[0];
   $allimages = "<img src='".$mainimage."'/><br><br>";
}
...
$html = file_get_html('http://fishki.net/best/');
...
foreach($html->find('.post_title') as $e) { 
...
foreach($html->find('.post_content_inner') as $e) { 
    
}
 
$maintext = strip_tags($e->children(2)->innertext,"<p>").'<br><br>';
